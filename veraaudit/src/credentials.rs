...
/// # Errors
///
/// Returns error if credential is empty or contains non-alphanumeric characters
...
/// # Errors
///
/// Returns error if environment variables are missing or validation fails
...
/// # Errors
///
/// Returns error if region parsing fails
